...
import { authClient } from "@/lib/auth-client"; // For client-side logout button if needed, or use server action
...
export default async function DashboardLayout({
    ...
    const navItems = [
        ...
        { name: "Reports", href: "/eods", icon: FileText },
                    ...
                    {navItems.map((item) => (
                        <Link 
                            ...
                            className={cn(
                                ...
                                // Active state logic would go here (e.g., using usePathname)
                            )}
                        >

                    ...
                    {isLoading ? (
                                ...
                                <div key={memo.id} className="p-8 flex flex-col md:flex-row gap-8 hover:bg-slate-50/50 transition-all duration-300 group">
                                    ...
                                    <div className="flex-1 space-y-4">
                                        ...
                                        <div className="flex flex-wrap items-center gap-3 pt-2">
                                            ...
                                            <Link href={`/admin/projects/${memo.projectId}`} className="text-[9px] font-black text-blue-600 uppercase tracking-widest hover:underline flex items-center gap-1">
                        ...
                        <div className="p-20 flex flex-col items-center justify-center text-center space-y-6">
                            ...
                            <div className="max-w-xs space-y-2">
                                ...
                                <p className="text-sm text-slate-500 font-medium">No memos found matching your criteria.</p>
                            </div>

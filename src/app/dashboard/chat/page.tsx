...
export default function ChatListPage() {
    ...
    useEffect(() => {
        // Fetch chat groups with project info and developer counts
    ...
    return (
         <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight text-[#0f172a]">Project Chats</h2>
                    <p className="text-muted-foreground">Collaborate with your team members in project-wide group chats</p>
                </div>
            </div>
                                        ...
                                        <TableRow key={chat.id} className="group transition-colors hover:bg-slate-50/50">
                                            ...
                                            <TableCell className="text-right pr-6">
                                                <Button variant="ghost" size="sm" className="text-blue-600 font-bold hover:text-blue-700 hover:bg-blue-50" asChild>
                                                    <Link href={`/dashboard/chat/${chat.projectId}`}>
                                                        View More

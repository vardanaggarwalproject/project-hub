...
export default async function DashboardLayout({
    ...
    const mainItems = [
        ...
        { name: "Clients", href: "/dashboard/clients", icon: Users, requiredPermission: "CAN_VIEW_CLIENTS" as const },
        { name: "Projects", href: "/dashboard/projects", icon: FolderOpen, requiredPermission: "CAN_VIEW_PROJECTS" as const },
        { name: "Developers", href: "/dashboard/developers", icon: UserSquare2, requiredPermission: "CAN_VIEW_DEVELOPERS" as const },
    ].filter(item => !item.requiredPermission || hasPermission(userRole, item.requiredPermission));

    const managementItems = [
        { name: "Roles & Access", href: "/dashboard/admin/users", icon: ShieldCheck, requiredPermission: "CAN_MANAGE_USERS" as const },
        { name: "Memos", href: "/dashboard/memos", icon: FileText, requiredPermission: "CAN_VIEW_PROJECTS" as const },
        { name: "EOD Reports", href: "/dashboard/eods", icon: ClipboardList, requiredPermission: "CAN_VIEW_PROJECTS" as const },
        { name: "Project Chat", href: "/dashboard/chat", icon: MessageSquare, requiredPermission: "CAN_CHAT" as const },
        { name: "Links", href: "/dashboard/links", icon: LinkIcon, requiredPermission: "CAN_VIEW_PROJECTS" as const },
        { name: "Assets", href: "/dashboard/assets", icon: FileCode2, requiredPermission: "CAN_VIEW_PROJECTS" as const },
    ].filter(item => !item.requiredPermission || hasPermission(userRole, item.requiredPermission));

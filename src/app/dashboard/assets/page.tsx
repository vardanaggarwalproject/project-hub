            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div>
                    <h2 className="text-3xl font-black tracking-tight text-[#0f172a] uppercase italic">
                        The Hub <span className="text-indigo-600">/</span> Assets
                    </h2>
                    <p className="text-muted-foreground mt-1 text-sm font-bold uppercase tracking-widest opacity-70">
                        Unified storage for project blueprints, designs, and deliverables
                    </p>
                </div>
                    ...
                    {isLoading ? (
                        ...
                        <div className="p-20 flex flex-col items-center justify-center text-center space-y-6">
                            ...
                            <div className="max-w-xs space-y-2">
                                ...
                                <p className="text-sm text-slate-500 font-medium">No assets have been deposited. Start uploading files to your projects to populate the vault.</p>
                            </div>
                        </div>
                    )}
                </CardContent>

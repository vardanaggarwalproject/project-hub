            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div>
                    <h2 className="text-3xl font-black tracking-tight text-[#0f172a] uppercase italic">
                        The Hub <span className="text-blue-600">/</span> Shared Links
                    </h2>
                    <p className="text-muted-foreground mt-1 text-sm font-bold uppercase tracking-widest opacity-70">
                        Central directory for external project resources and documentation
                    </p>
                </div>
                    ...
                    {isLoading ? (
                                ...
                                <Card key={link.id} className="group border-none shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden bg-white ring-1 ring-slate-100 hover:ring-blue-100">
                                    <div className="p-6 space-y-4">
                                        ...
                                        <div className="pt-4 flex items-center justify-between border-t border-slate-50">
                                            ...
                                            <Link href={`/dashboard/projects/${link.projectId}`} className="text-[8px] font-black text-blue-600 uppercase tracking-widest hover:underline">
                                                Go to Source
                                            </Link>
                                        </div>
                                    </div>
                        ...
                        <div className="p-20 flex flex-col items-center justify-center text-center space-y-6">
                            ...
                            <div className="max-w-xs space-y-2">
                                ...
                                <p className="text-sm text-slate-500 font-medium">No links have been cataloged yet. Add external resources within your projects to see them here.</p>
                            </div>
                        </div>
                    )}
                </CardContent>
